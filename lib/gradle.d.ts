 ...
 */
export declare function getTaskToPublish(cwd: string, pd: string, env: NodeJS.ProcessEnv, logger: Signale): Promise<string>;
/**
 * @param {string} cwd the path of current working directory
...
export declare function publishArtifact(cwd: string, pd: string, env: NodeJS.ProcessEnv, logger: Signale): Promise<unknown>;
